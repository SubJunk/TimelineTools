...
series.push(
  ...
  new Series('Astonishing Tales', {1: 1970}),
  ...
  new Series('Gambit', {1: 1993, 2: 1997, 3: 1999, 4: 2004}),
  new Series('Gambit and the X-Ternals', {1: 1995}),
  new Series('Generation Hope', {1: 2010}),
  ...
  new Series('Secret Invasion: X-Men', {1: 2008}),
  ...
  new Series('Thunderbolts', {2: 2006}),
  ...
  new Series('Wolverine', {1: 1982, 2: 1988, 3: 2003, 4: 2010}),
  ...
  new Series('X-Men', {2: 1991, 3: 2004, 4: 2010}),
  ...
  new Series('X-Men Declassified', {1: 2000}),
  new Series('X-Men Free Comic Book Day', {2008: 2008}),
  new Series('X-Men Forever', {1: 2001}),
  new Series('X-Men Giant-Size', {1: 2011}),
  ...
  new Series('X-Men: Hellbound', {1: 2010}),
  ...
  new Series('X-Men: Second Coming - Revelations: Blind Science', {1: 2010}),
  new Series('X-Men: Sword of the Braddocks', {1: 2009}),
