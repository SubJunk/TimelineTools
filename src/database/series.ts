...
series.push(
  ...
  new Series('Age of Apocalypse', {1: 2011}),
  ...
  new Series('Avengers Vs. X-Men', {1: 2012}),
  new Series('Avengers Vs. X-Men: Consequences', {1: 2012}),
  new Series('Avengers Vs. X-Men: Versus', {1: 2011}),
  ...
  new Series('Exiled', {1: 2011}),
  new Series('Factor X', {1: 1995}),
  new Series('Fantastic Four', {1: 1961}),
  new Series('Fantastic Four vs. the X-Men', {1: 1987}),
  new Series('Fear Itself', {1: 2011}),
  new Series('Fear Itself: The Deep', {1: 2011}),
  new Series('Fear Itself: Uncanny X-Force', {1: 2011}),
  new Series('Fear Itself: Wolverine', {1: 2011}),
  new Series('Fear Itself: The Book of the Skull', {1: 2011}),
  ...
  new Series('Journey into Mystery', {3: 2011}),
  ...
  new Series('Uncanny X-Men', {1: 1963, 2: 2011, 3: 2013}),
  ...
  new Series('Wolverine & the X-Men Annual', {1: 2013}),
  ...
  new Series('X-Men', {2: 1991, 3: 2004, 4: 2010, 5: 2013}),
  ...
  new Series('X-Men: Battle of the Atom', {1: 2013}),
  ...
  new Series('X-Men: Prelude to Schism', {1: 2011}),
  new Series('X-Men: Prime', {1: 1995}),
  new Series('X-Men: Regenesis', {1: 2011}),
  new Series('X-Men: Road to Onslaught', {1: 1996}),
  new Series('X-Men: Schism', {1: 2011}),
  ...
  new Series('X-Treme X-Men', {1: 2001, 2: 2012}),
  ...
  new Series('X-Termination', {1: 2013}),
