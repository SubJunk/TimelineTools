...
addComicsInSeriesVolume('AstonishingXMenXenogenesisVol1', [
  [1, '2010-5-12'],
  [2, '2010-6-9'],
  [3, '2010-9-22'],
  [4, '2010-12-29'],
...
addComicsInSeriesVolume('AvxConsequencesVol1', [
  [1, '2012-10-10'],
  [2, '2012-10-17'],
  [3, '2012-10-24'],
  [4, '2012-10-31'],
...
addComicsInSeriesVolume('EternalsAnnualVol2', [[1, '2008-11-12']]);
addComicsInSeriesVolume('EternalsManifestDestinyVol1', [
  [7, '2009-1-7'],
  [8, '2009-2-11'],
  [9, '2009-3-18'],
]);
...
addComicsInSeriesVolume('NightcrawlerVol3', [
  [1, '2004-9-22'],
  [2, '2004-11-10'],
  [3, '2004-12-8'],
  [4, '2004-12-22'],
...
addComicsInSeriesVolume('XMenFirstClassSpecialVol1', [[1, '2007-7-1']]);
addComicsInSeriesVolume('XMenFirstClassVol1', [
  [1, '2006-9-20'],
  [2, '2006-10-18'],
  [3, '2006-11-15'],
  [4, '2006-12-20'],
...
addComicsInSeriesVolume('XMenFirstClassVol2', [
  [1, '2007-5-16'],
  [2, '2007-7-25'],
  [3, '2007-8-22'],
  [4, '2007-9-26'],
...
addComicsInSeriesVolume('XMenTheLivesandTimesofLucasBishopVol1', [
  [1, '2009-2-4'],
  [2, '2009-3-25'],
  [3, '2009-4-22'],
]);
...
addComicsInSeriesVolume('XMenPhoenixEndsongVol1', [
  [1, '2005-1-5'],
  [2, '2005-2-2'],
  [3, '2005-2-23'],
  [4, '2005-3-30'],
